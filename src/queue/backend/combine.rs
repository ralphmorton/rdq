...
mod tests {
    ...
    use crate::queue::{Backend, DroppedItem, Error, Item, JsonItem};
    use crate::queue::backend::combine::{Combine, Either};
    ...
    fn enqueues_into_correct_backend() {
        ...
        let c = Combine::new(b1.clone(), b2.clone());
    ...
    fn dequeues_round_robin() {
        let b1 : TestBackend<JsonItem<i32>> = TestBackend::new();
        let b2 : TestBackend<JsonItem<i32>> = TestBackend::new();
        let mut c = Combine::new(b1.clone(), b2.clone());
